= It's fork the original Breadcrumbs On Rails

    <%= render_breadcrumbs(:no_html => true, :current_as_link => true) %>

:no_html is option that shows items without <a> tag for title tag.
:current_as_link does last item with <a> tag.
